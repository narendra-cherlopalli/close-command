...
with tabs[0]:
    ...
    c4.metric("Not Matched",           str(notmatched_count), delta="Small gap — review", delta_color="off")
    c5.metric("FX Diff (Cross-CCY)",   str(fxdiff_count), delta="Translation gap", delta_color="off")
    c6.metric("Exceptions",            str(exception_count), delta_color="inverse")
