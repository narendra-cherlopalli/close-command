...
with tabs[3]:
    ...
    POSTABLE_MATCH   = {"Matched", "Tolerance", CROSS_CCY_STATUS}
...
|---|---|---|---|---|---|
| 1 | Helios IC Source Upload (xlsx/csv) | Bilateral matching engine | Matched / FX_Diff / Tolerance / Exception | System | Auto |
| 2 | Matched + FX_Diff + Tolerance only | Rule determination (HFM UD3 logic) | Elimination rule code (IC-001, INV-001 etc.) | System | Auto |
